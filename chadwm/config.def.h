...
static const char *xi[] = {"bup", NULL}; /*increase brightness using light -S $(light -G | awk '{print $1 + 10}'*/
static const char *xd[] = {"bdown", NULL}; //decrease brightness light -S $(light -G | awk '{print $1 - 10}')
static Key keys[] = {
    /* modifier                     key        function        argument */
    { MODKEY,                       XK_c,      spawn,          {.v = rofi } },
    { MODKEY,                       XK_Return, spawn,          {.v = termcmd }},  
    { MODKEY,                       XK_s, spawn,          {.v = dmenucmd }},  
    { MODKEY|ShiftMask,             XK_u, spawn,          {.v = xi }},
    { MODKEY|ShiftMask,             XK_d, spawn,          {.v = xd }},
